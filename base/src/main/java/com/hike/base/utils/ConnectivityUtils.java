...
//    private static final String LOG_TAG = "ConnectivityUtils";
     ...
     * android.permission.ACCESS_NETWORK_STATE is required
     */
...
//    }
    ...
    private static NetworkInfo getActiveNetwork(Context pContext) {
        ConnectivityManager conMngr = null;
        if (pContext != null)
            conMngr = (ConnectivityManager) pContext.getSystemService(Context.CONNECTIVITY_SERVICE);
